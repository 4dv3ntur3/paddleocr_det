...
draw_img_save_dir="$1_unclip_ratio_${unclip_ratio}_normal_box_thresh_${box_thresh}_debugging"


python3 tools/infer/predict_det.py --image_dir=${image_dir_hard} --det_model_dir=$1 --draw_img_save_dir=${draw_img_save_dir} --det_db_unclip_ratio=${unclip_ratio} --det_db_box_thresh=${box_thresh}
